...
import DetailPresenter from "./detail-controller";
...
export default class DetailPage {
    ...
    _renderStoryDetail(story) {
        ...
        const storyHTML = `
      <article>
        <h1 id="content" tabindex="0" class="story-title">${story.name
            }'s Story</h1>
        <p class="story-date">${showFormattedDate(story.createdAt)}</p>
        <img src="${story.photoUrl}" alt="Story image from ${story.name
